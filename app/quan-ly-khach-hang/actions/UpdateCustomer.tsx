...
function UpdateCustomer(props: UpdateCustomerProps) {
  ...
  return (
    <Modal
      ...
      className='!w-1/2'
    >
      <h1 className="mb-4 text-2xl font-bold text-center">Cập nhật khách hàng <span className="text-[#2563eb]">{customer.fullName}</span></h1>
      <div>
        <Form
          form={form}
          onFinish={onSubmit}
