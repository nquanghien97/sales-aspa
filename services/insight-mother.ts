...
export function createInsightMother(data: { keyword: string, explain: string, solution: string  }) {
...
export function getInsightMother({ search, page, pageSize }: { search?: string, page?: number, pageSize?: number }) {
